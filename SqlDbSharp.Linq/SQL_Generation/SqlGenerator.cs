namespace System.Data.SqlDbSharp.Linq
{
	...
	{
		private SqlDbSharpProviderManifest _manifest;
		...
		/// Basic constructor. 
		/// </summary>
		private SqlGenerator(SqlDbSharpProviderManifest manifest)
		{
			_manifest = manifest;
		}
		#endregion
		...
		internal static string GenerateSql(SqlDbSharpProviderManifest manifest, DbCommandTree tree, out List<DbParameter> parameters, out CommandType commandType)
		{
		...
		private static ISqlFragment HandleGetDateFunction(SqlGenerator sqlgen, DbFunctionExpression e)
		{
			...
			{
			case SqlDbSharpDateFormats.Ticks:
				result.Append("(STRFTIME('%s', 'now') * 10000000 + 621355968000000000)");
				break;
			case SqlDbSharpDateFormats.JulianDay:
