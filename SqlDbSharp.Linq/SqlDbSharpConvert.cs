namespace System.Data.SqlDbSharp.Linq
{
	...
	/// </summary>
	public abstract class SqlDbSharpConvert
	{
		/// <summary>
		...
		internal SqlDbSharpConvert(SQLiteDateFormats fmt)
		{
			_datetimeFormat = fmt;
		}
...
/*		
		...
		internal static void ColumnToType(SqlDbSharpStatement stmt, int i, SQLiteType typ)
		{
...
*/
		...
		internal static Type SQLiteTypeToType(SQLiteType t)
		{
			if (t.Type == DbType.Object)
				...
				return SqlDbSharpConvert.DbTypeToType(t.Type);
		}
